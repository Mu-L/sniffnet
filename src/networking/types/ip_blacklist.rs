...
mod tests {
    ...
    async fn test_ip_blacklist_valid() {
        ...
        assert_eq!(blacklist.ip_count(), 4);
        assert_eq!(blacklist.network_count(), 0);
    ...
    async fn test_ip_blacklist_invalid() {
        ...
        assert_eq!(blacklist.networks.len(), 0);
        assert_eq!(blacklist.ip_count(), 0);
        assert_eq!(blacklist.network_count(), 0);
    ...
    async fn test_ip_blacklist_valid_with_cidr() {
        ...
        assert_eq!(blacklist.ip_count(), 2);
        assert_eq!(blacklist.network_count(), 4);
    ...
    async fn test_ip_blacklist_valid_with_cidr_only() {
        ...
        assert_eq!(blacklist.ip_count(), 0);
        assert_eq!(blacklist.network_count(), 1);
